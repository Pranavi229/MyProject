...
public class Vendor {
	...
	public Vendor(int vid, @NotNull String vname, @NotNull String regno, @NotNull String vendor_type,
			@NotNull String address, @NotNull String country, @NotNull String state, @NotNull String email_address,
			@NotNull int contact_no, @NotNull String website, @NotNull Date cer_Issued_Date,
			@NotNull Date certificate_Validity_date, @NotNull Date year_of_Establishment, @NotNull String pay,
			@NotNull String password, @NotNull boolean status) {
		super();
		this.vid = vid;
		this.vname = vname;
		this.regno = regno;
	...
	public String toString() {
		return "Vendor [vid=" + vid + ", vname=" + vname + ", regno=" + regno + ", vendor_type=" + vendor_type
				+ ", address=" + address + ", country=" + country + ", state=" + state + ", email_address="
				+ email_address + ", contact_no=" + contact_no + ", website=" + website + ", cer_Issued_Date="
				+ cer_Issued_Date + ", certificate_Validity_date=" + certificate_Validity_date
				+ ", year_of_Establishment=" + year_of_Establishment + ", pay=" + pay + ", password=" + password
				+ ", status=" + status + "]";
	}
